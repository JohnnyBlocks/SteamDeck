...
2.  Click on the '**Steam Icon**' in the lower left corner.  
    ...
    <img src="media/start_discovery_center.png" alt="drawing" width="60%"/>  
    <br><br>
3.  In the '**Discover Software Center**', search for '**Edge**'<br>
    When Microsoft Edge shows as a result, click on the '**Install**' button.<br>
    <img src="media/add_microsoft_edge.png" alt="drawing" width="60%"/>  
<br><br>
