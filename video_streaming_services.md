# How To Add Popular Video Streaming Services
...
<img src="media/add_nonsteam_header.jpg" alt="drawing" width="60%"/>  
## Step-by-Step
...
<img src="media/add_nonsteam_1.png" alt="drawing" width="60%"/>  
...
10.  Click in the Dark Square next to '**Disney+**' and change it to a Disney+ image file of your choice then close the '**SHORTCUT**' window.  <br/>
    <img src="media/add_nonsteam_4.png" alt="drawing" width="60%"/>

11. Disney+ is now in your game library as a non-steam game.  
    Restart into '**Game Mode**'

### C. Add Controller Layout, Grid Icons, Banner, and Heroes
<img src="media/add_nonsteam_5.jpg" alt="drawing" width="60%"/>  

12. Find '**Disney+**' in your game library and click on it to select it.

13. Click on the controller icon 🎮 to the right to add a controller layout.  
    The '**Disney+ Controller Settings**' window will open.  
    <img src="media/add_nonsteam_7.jpg" alt="drawing" width="60%"/>  


14. Select the Controller Layout that is ideal for you.  
...
<img src="media/add_nonsteam_6.jpg" alt="drawing" width="60%"/>    
...
16. Launch the newly added app, log in with your account, and start streaming.  
